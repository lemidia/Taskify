      ...
      <div className="w-full">
        <form action={onSubmit}>
          <FormInput
            ...
            id="title"
            defaultValue={title}
            className="font-semibold text-xl h-7 px-1 text-neutral-700 bg-transparent border-transparent relative -left-1.5 w-[95%] focus-visible:bg-white focus-visible:border-input mb-0.5 truncate"
          />
        </form>
